    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            $features = [
                ...
                ['icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/>', 'title' => 'Wallet System', 'desc' => 'Secure wallet with full transaction history and balance management.'],
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid sm:grid-cols-3 gap-8">
            ...
            $steps = [
                ...
                ['num' => '02', 'title' => 'Add Balance', 'desc' => 'Fund your wallet using your preferred payment method.'],
                ['num' => '03', 'title' => 'Buy & Use', 'desc' => 'Purchase a number and start receiving SMS messages.'],
            ];
            @endphp
