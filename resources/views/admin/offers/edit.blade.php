...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <x-admin.card>
        <form method="POST" action="{{ route('admin.offers.update', $offer) }}" class="space-y-5" enctype="multipart/form-data">
            @csrf @method('PUT')
            ...
            <div class="border-t border-dark-800 pt-5 space-y-4">
                @include('admin.partials.image-upload', ['current' => $offer->image, 'label' => 'Image'])
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
