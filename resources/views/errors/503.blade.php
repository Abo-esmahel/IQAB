...
<body class="bg-dark-950 min-h-screen flex items-center justify-center">
    <div class="text-center">
        <h1 class="text-7xl sm:text-9xl font-bold text-white mb-4">503</h1>
        <p class="text-xl text-dark-400 mb-8">Service is temporarily unavailable. Please try again later.</p>
