...
<body class="bg-dark-950 min-h-screen flex items-center justify-center">
    <div class="text-center">
        <h1 class="text-7xl sm:text-9xl font-bold text-white mb-4">500</h1>
        <p class="text-xl text-dark-400 mb-8">Something went wrong on our end. Please try again later.</p>
